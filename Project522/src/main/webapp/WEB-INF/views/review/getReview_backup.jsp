		...
		<div class="container px-4 px-lg-5 mt-5 ">
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="owl-cites-town owl-carousel">
										<div class="item">
						                  <div class="thumb">
						                    <img src="../../resources/img/cities-01.jpg" alt="">
						                    <h4>Havana</h4>
						                  </div>
						                </div>
						                <div class="item">
						                  <div class="thumb">
						                    <img src="../../resources/img/cities-02.jpg" alt="">
						                    <h4>Kingston</h4>
						                  </div>
						                </div>
									</div>
			...
			<div id="reviewcontents" class="ec-base-tab gFlex  row mt-3">
				<div class="col-md-5 board" style="width:100%;" >
					...
					<form>
						<textarea  style="width:80%;margin-left:15px;" rows="12" name="review_Content"
			...
			<div class="ec-base-tab gFlex  row">
				<div class="board" style="padding:10px; margin-left:18px">
